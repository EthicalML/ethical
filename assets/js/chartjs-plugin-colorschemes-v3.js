			...
			chart.config.data.datasets.forEach(function(dataset, datasetIndex) {
				...
				case 'scatter':
					if (typeof dataset.backgroundColor === 'undefined' || override) {
						...
						dataset.backgroundColor = Chart.helpers.color(newColor).alpha(fillAlpha).rgbString();
					}
					...
					if (typeof dataset.pointBackgroundColor === 'undefined' || override) {
						...
						dataset.pointBackgroundColor = Chart.helpers.color(newColor).alpha(fillAlpha).rgbString();
					}
...
window.ColorSchemesPlugin = ColorSchemesPlugin;

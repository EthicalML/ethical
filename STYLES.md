...
| `ArticleBody.astro` and `ArticleBody.css`                                         | Shared newsletter and blog long-form article body: text measure, wide media breakout to the deck width, first-section separator suppression, markdown pull-quote inheritance, code, images and table overflow | `.article-body`, `.article-section`, `.article-table-scroll`                                    |
...
| `pages/blog/[slug].astro`                                                         | Blog post meta bar, chips, series steps, byline, syndication links and related-post block                                                                                                                     | `.blog-meta`, `.blog-chips`, `.blog-step`, `.blog-byline`, `.blog-syndication`, `.blog-related` |
...
<!-- styles-hash: 5b106bc07121cfeda02d0784f7c227e52c24c98abf14b2d7fb27daeddd8a463b -->

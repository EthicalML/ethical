...
| Header logo collapse         | Every route: the header logo holds the two-line wordmark for 1800ms, collapses its own I, E, A and S into the 2x2 mark over 900ms while the other letters scatter and thin, holds 1800ms and reverses; one rAF clock, one eased value, FLIP-measured off the live glyphs. The outer link reserves the at-rest box so the nav row never reflows. Below 1040px it is the static mark; under reduced motion the static wordmark                                                                                                                                                                                                      | `SiteLogo`, `SiteHeader`                                                              |

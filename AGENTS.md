...
| Section reveal               | Every `data-reveal` element on every route: fires at 45% visibility, with a 45vh fallback for elements too tall to reach it, an unreachable-threshold check and a page-bottom failsafe; `data-reveal="trigger"` roots get the timing signal (`reveal:visible`) without the fade                                                                                                                                                                                                                                                                                                                                                   | `Reveal`, `BaseLayout`                                                                |

...
3. Open http://127.0.0.1:4173/#0.1. All runtime assets are local.
...
9. Use a separately exported PDF if a backup is needed; the site does not ship slide screenshots.

  ...
  <div className="outcome-stories">
    <article>
      ...
      <p>
        ...
        >
          primary response records the adoption.
        </a>
      </p>
    </article>
    <article>
      ...
      <p>
        The 13-of-14 adoption total for the UK's AI regulatory proposal is owner-attested. The
        <a href="https://www.acm.org/binaries/content/assets/public-policy/europe-tpc-uk-ai-framework-comments.pdf" target="_blank" rel="noopener noreferrer">
          2022 framework comments are the related first-stage artefact.
        </a>
      </p>
    </article>
  </div>
...
<section className="policy-section policy-bridge" data-reveal aria-labelledby="bridge-heading">
  ...
  <p className="bridge-attribution">
    Alejandro Saucedo is named as an author or contributor on 11+ products in this record. He is credited as principal author of five — the 2021 AI Act, 2022
    Data Act, 2022 UK framework, 2020 UK National Data Strategy and 2021 Digital Principles responses — and as a lead author of the 2023 joint Generative AI
    Principles; each credits him as Chief Scientist of the Institute.
  </p>
  <div className="bridge-grid">
    <article>
      ...
      <p>
        ...
        <a href="/frameworks/security/">MLSecOps framework</a> is cited by both the{' '}
        <a
          href="https://www.acm.org/binaries/content/assets/public-policy/acm-europetpc-consultation-2024---general-purpose-ai-code-of-practice.pdf"
          target="_blank"
          rel="noopener noreferrer"
        ...
        GPAI Code responses alongside MITRE ATT&CK, OWASP and UK NCSC taxonomies in Recommendation 10.
      </p>
    </article>
    <article>

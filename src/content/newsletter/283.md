...
issue: 283
date: 2024-05-19
summary: 'Ways to Deploy an ML Model, xLSTM Innovation in ML, Llama3 Implemented in NumPy, META Scaling Law for RecSys, GPUs Go Brrr + more 🚀'
...
## This week in [Machine Learning](https://ethical.institute/mle/283.html):

- Ways to Deploy [an ML Model](https://outerbounds.com/blog/the-many-ways-to-deploy-a-model/)
- xLSTM Innovation [in ML](https://arxiv.org/abs/2405.04517)
- Llama3 Implemented [in NumPy](https://docs.likejazz.com/llama3.np/)
- META Scaling Law [for RecSys](https://arxiv.org/abs/2403.02545)

...
Today we celebrate together our [400th Issue](/newsletter/400/) 🚀🚀🚀 This is a HUGE milestone, and it lands just a week after we announced [the new face of the Institute](/newsletter/399/), which makes it an even better moment to look at how far this has come with YOU:

- [MLE Newsletter](/newsletter/) reaching 70k+ AI professionals every week 🥳
- [Production ML List](/open-source/production-ml-list/) reached 20.8k Stars across 550+ libraries 🌠
- [Kompute Framework](https://github.com/KomputeProject/kompute) reached 2.5k Stars 🌟
- [AI Guidelines List](/open-source/ai-guidelines/) reached 1.4k Stars 🎁
- [XAI Toolset](/open-source/xai/) reached 1.3k Stars 🎉

From the first issue in 2018 to today, the through-line has been the same, namely making production machine learning something we can all do well and do responsibly. Thank you for being part of it, and bring on 400 more 🚀

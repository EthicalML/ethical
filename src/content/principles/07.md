...
description: Frontier Models can hold data from people who never used them. Deployers must design privacy into every layer to limit exposure and enable trust.

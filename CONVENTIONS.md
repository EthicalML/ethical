...
| Policy achievement studies  | `/prototypes/policy-achievements/?v=1..4` stacked cell-grid of long and short content blocks over inert grey duds (square, diamond, triangle), bottom-up lego falls, per-block card-displacing neon slide reveals, and per-variant ghost, isometric, crack and circuit surfaces at both card sizes | `AchievementNeonRendition`                                                            |

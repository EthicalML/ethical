...
| Flagship initiative carousel | Homepage 04 snap carousel (thin teaser lead-in, survey card at two-thirds width): enters at 50% visibility sliding in from the right showing the teaser, one 6s auto-advance from the teaser to the survey card cancelled by any interaction, otherwise user-controlled via full-height edge zones in the section padding; no entrance or advance under reduced motion; horizontal at every width | `OpenSourceShowcase`                                                                  |

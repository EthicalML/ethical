...
| Policy hero canvas studies  | `/prototypes/policy-hero/?v=1..5`                                    | `PolicyHeroPhraseGravity`, `PolicyHeroDottedPlanet`, `PolicyHeroBraceTerrain`, `PolicyHeroIsometricAssembly`, `PolicyHeroPolicyCircuit`, `PolicyHeroIso`, `CanvasEngine` |

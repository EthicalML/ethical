...
| Policy hero canvas studies  | `/prototypes/policy-hero/?v=1..5`                                    | `PolicyHeroPhraseGravity`, `PolicyHeroDottedPlanet`, `PolicyHeroPhraseTerrain`, `PolicyHeroPolicyCircuit`, `PolicyHeroCircuitConfigurations`, `PolicyHeroIso`, `CanvasEngine` |
...
| Policy achievement studies  | `/prototypes/policy-achievements/?v=1..5` wave cell-grid of long and short blocks, bottom-up lego falls, per-block clipped slide reveals, and per-variant ghost, isometric, transformer, crack and circuit surfaces at both card sizes | `AchievementNeonRendition`                                                            |

...
| Memory prototype playback   | `/prototypes/memory/` call, lifecycle and tenant-isolation studies   | `AnimationWindow`, `MemoryCallFlowPrototype`, `MemoryLifecyclePrototype`, `MemoryIsolationPrototype` |

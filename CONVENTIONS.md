...
| Flagship initiative carousel | Homepage 04 snap carousel (static teaser lead-in, survey card at two-thirds width): infinite wrap via edge clones, position bubbles above the track (active stretches to a pill, click travels, follows scroll), hairline-blade prev/next zones in the section padding (white-scale hover tick, pressed pulse); enters at 50% visibility sliding in from the right, one 4s auto-advance counted down on the active bubble and flashed on the next blade, cancelled by any interaction; no entrance, countdown or advance under reduced motion; horizontal at every width | `OpenSourceShowcase`                                                                  |
...
| Policy achievement set table | `/policy/` set-table card grid: bottom-up lego falls, neighbour nudges, ghost-rule wipes, and per-block card-displacing neon reveals; a freeform collage variant is kept reusable (see `REUSABLE.md`)                                                                                                                                                                                                                                                                                                                                                                    | `AchievementNeonRendition`                                                            |
